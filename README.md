...
* [aelf-bridge-demo](https://github.com/AElfProject/aelf-bridge-demo): This demo used `iframe` to overwrite `dapp.html`'s `postMessage` to simulate communication with mobile App;
